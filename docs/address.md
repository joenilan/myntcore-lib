# Mynt Address
Represents a mynt address. Addresses are the most popular way to make mynt transactions. See [the official Bitcoin Wiki](https://en.bitcoin.it/wiki/Address) for technical background information.

## Instantiate an Address
To be able to receive mynts an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
...
The errors are listed in the generated file in the [errors folder](https://github.com/joenilan/myntcore/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/joenilan/myntcore/tree/master/lib/errors/spec.js).
