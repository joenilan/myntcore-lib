# Public Key
Represents a mynt public key and is needed to be able to receive mynt, as is usually represented as a mynt [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).

A PublicKey in myntcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = myntcore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new myntcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = myntcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
